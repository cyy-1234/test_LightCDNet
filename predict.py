...
def get_argparser():
    ...
    parser.add_argument("--data_root", type=str, default=r'LEVIR-CD',
                        help="path to Dataset")
    parser.add_argument("--save_val_results_to", default=r'LEVIR-CD',
...
def main():
    ...
    with torch.no_grad():
        ...
        for image1,image2,target,id in tqdm(test_loader):
            ...
            image1, image2, target = image1, image2, target
